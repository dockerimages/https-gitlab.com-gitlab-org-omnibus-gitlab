...
1. In GitLab 15.0 (JUne 2022) we remove PostgreSQL 12, minimally require PostgreSQL 13, and add support for PostgreSQL 14.
...
1. Run `cp config/software/postgresql{,_new}.rb`
