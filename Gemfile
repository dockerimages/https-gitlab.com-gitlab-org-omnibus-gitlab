...
omnibus_gem_version = Gitlab::Version.new('omnibus', "1c26e0e4656435f75b0fcbef4833e941aee818dc")
...
gem 'omnibus', git: omnibus_gem_version.remote, ref: omnibus_gem_version.print(false)
gem 'chef', '~> 15.14.0'
gem 'ohai', '~> 15.12.0'
