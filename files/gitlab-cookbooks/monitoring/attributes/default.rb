...
default['monitoring']['grafana']['smtp_enabled'] = false
default['monitoring']['grafana']['smtp_host'] = 'localhost:25'
default['monitoring']['grafana']['smtp_user'] = 'user'
default['monitoring']['grafana']['smtp_password'] = 'password'
default['monitoring']['grafana']['smtp_cert_file'] = nil
default['monitoring']['grafana']['smtp_key_file'] = nil
default['monitoring']['grafana']['smtp_skip_verify'] = false
default['monitoring']['grafana']['smtp_from_address'] = 'admin@grafana.localhost'
default['monitoring']['grafana']['smtp_from_name'] = 'Grafana'
default['monitoring']['grafana']['smtp_ehlo_identity'] = 'dashboard.example.com'
