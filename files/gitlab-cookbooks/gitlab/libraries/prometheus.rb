...
module Prometheus
  class << self
    ...
    def gitaly_scrape_config
      ...
      return unless Services.enabled?('gitaly') || Services.enabled?('consul')
    ...
    def sidekiq_scrape_config
      ...
      return unless Services.enabled?('sidekiq') || Services.enabled?('sidekiq_cluster') || Services.enabled?('consul')
    ...
    def rails_scrape_configs
      if Services.enabled?('unicorn') || Services.enabled?('consul')
        default_config = Gitlab['node']['gitlab']['unicorn'].to_hash
        user_config = Gitlab['unicorn']
      elsif Services.enabled?('puma') || Services.enabled?('consul')
    ...
    def workhorse_scrape_config
      ...
      return unless Services.enabled?('gitlab_workhorse') || Services.enabled?('consul')
    ...
    def exporter_scrape_config(exporter)
      ...
      return unless Services.enabled?("#{exporter}_exporter") || Services.enabled?('consul')
    ...
    def nginx_scrape_config
      ...
      return unless Services.enabled?('nginx') || Services.enabled?('consul')
