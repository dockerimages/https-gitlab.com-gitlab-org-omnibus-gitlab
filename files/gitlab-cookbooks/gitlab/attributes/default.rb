...
default['gitlab']['postgresql']['logging_collector'] = nil
default['gitlab']['postgresql']['log_destination'] = "stderr" # only used if logging_collector is set to non-nil
default['gitlab']['postgresql']['log_line_prefix'] = nil
default['gitlab']['postgresql']['log_statement'] = nil
default['gitlab']['postgresql']['log_rotation_age'] = "1d"    # only used if logging_collector is set to non-nil
default['gitlab']['postgresql']['log_rotation_size'] = "10MB" # only used if logging_collector is set to non-nil
default['gitlab']['postgresql']['log_error_verbosity'] = nil
