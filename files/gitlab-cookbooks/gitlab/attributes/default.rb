...
default['gitlab']['mattermost-nginx']['redirect_http_to_https'] = false
default['gitlab']['mattermost-nginx']['redirect_http_to_https_port'] = 80
...
default['gitlab']['pages-nginx']['redirect_http_to_https'] = false
default['gitlab']['pages-nginx']['redirect_http_to_https_port'] = 80
...
default['gitlab']['registry-nginx']['redirect_http_to_https'] = false
default['gitlab']['registry-nginx']['redirect_http_to_https_port'] = 80
