...
dependent_services = []
dependent_services << "gitlab_service[unicorn]" if omnibus_helper.should_notify?("unicorn")
dependent_services << "gitlab_service[puma]" if omnibus_helper.should_notify?("puma")
dependent_services << "gitlab_service[sidekiq]" if omnibus_helper.should_notify?("sidekiq")
dependent_services << "gitlab_service[sidekiq-cluster]" if omnibus_helper.should_notify?("sidekiq-cluster")
