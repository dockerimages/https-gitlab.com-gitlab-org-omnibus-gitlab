    ...
    class << self
      ...
      def list(existing_config = nil)
        ...
        deprecations = [
          ...
          {
            config_keys: %w(gitlab-pages daemon-uid),
            deprecation: '14.4',
            removal: '15.0',
            note: "This parameter was introduced to drop privileges of the Pages app because it needed root to create a chroot and spawn an unprivileged child. Since chroot has been removed this flag is not needed and Pages can be run with an unprivileged account."
          },
          {
            config_keys: %w(gitlab-pages daemon-gid),
            deprecation: '14.4',
            removal: '15.0',
            note: "This parameter was introduced to drop privileges of the Pages app because it needed root to create a chroot and spawn an unprivileged child. Since chroot has been removed this flag is not needed and Pages can be run with an unprivileged account."
          },
