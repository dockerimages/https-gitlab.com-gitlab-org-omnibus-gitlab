...
describe 'crond::enable' do
  let(:chef_run) { ChefSpec::SoloRunner.new(step_into: %w(gitlab_service runit_service)).converge('crond::enable') }
  ...
  it "should pass correct options to gitlab_service" do
