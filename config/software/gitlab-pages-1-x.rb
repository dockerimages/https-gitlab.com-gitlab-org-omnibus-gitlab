...
version = Gitlab::Version.new('gitlab-pages', '1.5.0')

name 'gitlab-pages-1-x'
...
build do
  ...
  move 'gitlab-pages', "#{install_dir}/embedded/bin/gitlab-pages-1-x"
  ...
  copy "license.csv", "#{install_dir}/licenses/gitlab-pages-1-x.csv"
end
